...
export function AddTransactionForm({
  ...
  // ✅ Receipt Scan Handler — auto fills and selects category
    ...
    if (scannedData) {
      ...
      if (scannedData.category) {
        ...
        if (matchedCategory) {
          ...
          toast.success(`Category auto-selected: ${matchedCategory.name}`);
        } else {
          toast.warning("Could not match category, please select manually");
        }
      }
